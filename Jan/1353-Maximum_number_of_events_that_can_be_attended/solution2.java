...
class Solution {
	...
	public int maxEvents(int[][] events) {
		TreeSet<int[]> eventTrees = new TreeSet<>((a,
				b) -> (Integer.compare(a[0], b[0]) == 0 ? Integer.compare(a[2], b[2]) : Integer.compare(a[0], b[0])));
		...
		while (!eventTrees.isEmpty()) {
			Iterator<int[]> headSet = eventTrees.headSet(new int[] { day, day, len }).iterator();
	...
	public static void main(String[] args) {
		new Solution().maxEvents(new int[][] { { 1, 2 }, { 2, 3 }, { 3, 4 } });
		// [[1,4],[4,4],[2,2],[3,4],[1,1]]
		// [[ 1, 2 ], [ 1, 2 ], [ 3, 3 ], [ 1, 5 ], [ 1, 5 ]]
	}
}
